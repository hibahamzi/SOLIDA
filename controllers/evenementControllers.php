...
class evenementController {
    ...
    private function sendEmailToUser($userEmail, $userName, $subject, $htmlBody) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'chaimaferchichi26@gmail.com';
            $mail->Password = 'lisw qfze jwbl iuzm';
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;
            $mail->CharSet = 'UTF-8';
            
            // Recipients
            $mail->setFrom('chaimaferchichi26@gmail.com', 'SOLIDA - web-chaima');
            $mail->addAddress($userEmail, $userName);
            $mail->addReplyTo('chaimaferchichi26@gmail.com', 'SOLIDA Support');
