...
require_once __DIR__ . '/../views/front_office/verify_captcha.php';
...
public function handleSignin() {
    ...
    /* ================= CAPTCHA CHECK ================= */
    if (empty($captcha) || !verifyRecaptcha($captcha)) {
        $_SESSION['signin_message'] = "Veuillez confirmer que vous n'êtes pas un robot.";
