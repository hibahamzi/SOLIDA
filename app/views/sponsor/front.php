...
<!-- ======= Top Nav noir (copié du template, adapté) ======= -->
...
<div class="container py-5">
    ...
    <h2 class="hero-title">🏆 CATÉGORIES DE SPONSORING</h2>
    <div class="categories">
        <p>███ <strong>OR (500€)</strong> — Logo sur tous les supports, stand événements, speech</p>
        <p>███ <strong>ARGENT (300€)</strong> — Logo site web, mention communications</p>
        <p>███ <strong>BRONZE (200€)</strong> — Logo page sponsors, réseaux sociaux</p>
    </div>

    <h2 class="hero-title">🎪 ÉVÉNEMENTS RÉCENTS SPONSORISÉS</h2>
    <div class="events-grid">
        <div class="event-card">🎓 Hackathon<br>Sponsor: TechCo<br>Budget: 800€</div>
        <div class="event-card">🎤 Concert<br>Sponsor: Music+<br>Budget: 600€</div>
        <div class="event-card">⚽ Tournoi Sport<br>Sponsor: SportZ<br>Budget: 400€</div>
    </div>

    <div class="cta">
        <button class="btn1">📧 Nous Contacter</button>
        <button class="btn2">📋 Voir les avantages</button>
        <button class="btn3">💼 Télécharger PDF</button>

        <a class="btn-link btn-add-sponsor"
           href="http://localhost:8080/PROJET_WEB_MVC_FINAL/public/index1.php?controller=sponsor&action=create">
            ➕ Devenir sponsor / Ajouter un sponsor
        </a>

        <a class="btn-link btn-add-sponsor"
           href="http://localhost:8080/PROJET_WEB_MVC_FINAL/public/index1.php?controller=deal&action=create">
