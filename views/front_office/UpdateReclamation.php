<?php
// updateReclamation.php - Version complète avec validation en temps réel
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($priorite_selectionnee)) {
    ...
    if (!$has_errors) {
        try {
            ...
            $success = $reclamationController->updateReclamation($dataToUpdate);

            if ($success) {
                header('Location: listeReclamation.php?success=updated&id=' . $id);
                exit;
            } else {
...
<body>
    ...
    <div class="main-container">
        <div class="form-container">
            ...
            <form method="POST" id="reclamationForm" onsubmit="return validateForm()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-tel">
                            ...
                            <input type="text" id="telephone" name="telephone" value="<?php echo htmlspecialchars($telephone); ?>" 
                                   ...
                                   pattern="[0-9]{8}" title="Doit contenir 8 chiffres">
                        </div>
                ...
                <a href="ListReclamation.php" class="back-link">← Retour à la liste des Réclamations</a>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function setupRealTimeValidation() {
            const fields = {
                'nom': { min: 2, required: true },
                'prenom': { min: 2, required: true },
