...
<html lang="fr">
<head>
    <title>Réinitialiser le mot de passe - SOLIDA</title>
    <meta charset="utf-8">
    ...
    <section class="signin-section">
        <div class="container">
            <div class="signin-box">
                ...
                <form id="verifyCodeForm" action="../../controllers/userControllers.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            type="text" 
                            class="form-control <?php echo isset($errors['verification_code']) ? 'is-invalid' : ''; ?>" 
                            id="verification_code" 
                            name="verification_code" 
                            placeholder="Entrez le code reçu par email" 
                            value="<?php echo htmlspecialchars($oldInput['verification_code'] ?? ''); ?>"
                        >
                        <?php if (isset($errors['verification_code'])): ?>
                        <div class="invalid-feedback"><?php echo $errors['verification_code']; ?></div>
                        <?php endif; ?>
                    </div>
                ...
                <form id="resetPasswordForm" action="../../controllers/userControllers.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            ...
                            id="new_password" 
                            name="new_password" 
                            placeholder="Minimum 8 caractères avec au moins un chiffre ou symbole" 
                        >
                ...
                <p class="mt-3 text-center">
                    <a href="sign-in.php" class="text-success fw-bold">Retour à la connexion</a>
                </p>
            </div>
        </div>
    </section>
